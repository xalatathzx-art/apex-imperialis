...
const origin = {
  shrine: U("Compendium.apex-imperialis.navis-core-items.Item.i7qRAalBsnddJYeW", "Мир-храм"),
  hive: U("Compendium.apex-imperialis.navis-core-items.Item.OjFcYwOwNH6WlUjT", "Мир-улей"),
  void: U("Compendium.apex-imperialis.navis-core-items.Item.bFXPJAp4GsM8TB8F", "Пустота"),
  schola: U("Compendium.apex-imperialis.navis-core-items.Item.7E0Gkel1gSaxTgVu", "Схола Прогениум"),
  feudal: U("Compendium.apex-imperialis.navis-core-items.Item.pzvSXkckglOmZgdk", "Феодальный мир"),
  feral: U("Compendium.apex-imperialis.navis-core-items.Item.jPXulXRUoZ099Cwl", "Дикий мир"),
  forge: U("Compendium.apex-imperialis.navis-core-items.Item.5SLj6QlgqqR0K5GX", "Мир-кузница")
};
    ...
    pages: {
      ...
      Conditions: {
        ...
        text:
          ...
          `${U("Compendium.apex-imperialis.navis-core-items.Item.qjjlckQ3WvF4KLxO", "инструментов хирургеона")}.</p>` +
          ...
          `${U("Compendium.apex-imperialis.navis-core-items.Item.qjjlckQ3WvF4KLxO", "инструментов хирургеона")}. ` +
